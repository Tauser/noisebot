...
class FirmwareDiagClient:
    ...
    def audio_voice_v2_status(self) -> dict[str, Any]:
        payload = self._get_json("api/audio/voice-v2")
        if not isinstance(payload, dict):
            raise FirmwareDiagError("api/audio/voice-v2: resposta invalida")
        return payload
    ...
    def audio_playback_v2_speaker_owner_arm(self) -> dict[str, Any]:
        return self._post_json("api/audio/playback-v2/speaker-owner/arm")
    ...
    def audio_io_v2_speaker_handoff_owner_arm(self) -> dict[str, Any]:
        return self._post_json("api/audio/io-v2/speaker-handoff/owner/arm")

    def audio_io_v2_speaker_handoff_owner_disarm(self) -> dict[str, Any]:
        return self._post_json("api/audio/io-v2/speaker-handoff/owner/disarm")
