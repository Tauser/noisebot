# BRIDGE_V2.md — Arquitetura do Bridge v2 [SUPERADO]

> **Status: superado.** `bridge_v2/` foi a base da implementacao, mas a
> migracao para `server/` (`noisebot_server`) esta concluida — o server roda
