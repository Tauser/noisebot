...
| `DUAL_MCU_MIGRATION_ROADMAP.md` | Ordem canônica, propriedade por domínio, conexões, subfases fechadas e gates da migração dual-MCU. |
| `DM2_DISPLAY_MIGRATION.md` | Plano executável da migração do display/render para o head. |
