"""bridgev2.vision.analyzer -- Analise visual local sobre snapshots JPEG."""
...
def analyze_jpeg(jpeg_bytes: bytes, observation: "VisionObservation") -> VisionAnalysis:
    """Detecta rosto no JPEG usando OpenCV quando disponivel.

    O firmware mantem a captura leve; a classificacao visual fica no bridge,
    onde CPU/memoria sao menos criticas que no ESP32-S3.
    """
    try:
