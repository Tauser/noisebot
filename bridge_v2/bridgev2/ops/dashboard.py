"""bridgev2.ops.dashboard — HTML do painel de operação local.
...
<title>Bridge v2 · Dashboard</title>
<style>
:root {
...
<!-- Header -->
<div class="header">
  <span class="header-title">NoiseBot Bridge v2</span>
...
<div class="card">
  ...
  <div class="token-section">
    <input type="password" id="token-input" placeholder="Cole o token de ~/.bridgev2/ops_token"
  ...
  <p style="margin-top:6px;font-size:11px;color:var(--muted)">
    Encontre o token em <code style="font-family:var(--mono)">~/.bridgev2/ops_token</code>
...
const CATALOG = {
  ...
  ollama: ['gemma4:12b','qwen3.5:9b','qwen2.5:7b','qwen2.5:14b','llama3.1:8b','llama3.2:3b','mistral:7b'],
  none:   [],
};
...
async function doRestart() {
  ...
  try {
    ...
    showToast('Reinício gracioso agendado. O bridge ficará offline em breve.');
