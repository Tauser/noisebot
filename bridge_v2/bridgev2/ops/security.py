"""bridgev2.ops.security — Token local + allowlist de IP (Fase 9.5).
...
_TOKEN_FILE = Path.home() / ".bridgev2" / "ops_token"
_LOCALHOST = {"127.0.0.1", "::1", "localhost"}


def load_or_create_token() -> str:
    """Carrega token de NOISEBOT_OPS_TOKEN, arquivo ~/.bridgev2/ops_token ou cria um novo."""
