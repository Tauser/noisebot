...
#define NB_BRIDGE_OPUS_FRAME_MS       60    /* contrato Opus opt-in             */
 ...
 *
 * Retorna true quando o transporte Opus opt-in está ativo.
 */
 ...
 *
 * Enfileira o pacote Opus no bridge quando o transporte Opus está ativo.
 *
